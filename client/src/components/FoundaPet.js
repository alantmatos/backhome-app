...
const FoundaPet = () => {
    ...
    { pet ? pet.map(dog => { petArray.push(dog) }) : console.log("Pet has not been assigned") }
        ...
        return (
                <div key={dog.id} className='display_container'>
                    <div className="display_card">
                        <h3> Doggie Info</h3>                        
                    <img className='dog_profile_image' src={dog.img_url}></img>
                    <h3>{dog.name}</h3>
                    <h3>Age: {dog.age}.</h3>
    ...
    const renderDogOwner = petArray.map(dog => {
        return (
            <div key={dog.owner.phone} className="display_container">
                <div className="display_card">               
                <h3> Owner Info </h3>
                <img className='owner_profile_image' src={dog.owner.img_url}></img>
